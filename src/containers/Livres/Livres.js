...
class Livres extends Component{
    state = {
        livres : [
            ...
            {id:4, titre:"Le Virus d'Asie", auteur:"Abou DIALLO", nbPages:120},
        ],
        lastIdLivre : 4,
        idLivreAModifier : 0,
        alertMessage : null
    ...
    handleSuppressionLivre = (id) => {
        ...
        this.setState({
            livres: newLivres,
            alertMessage : {
                message : "Suppresseion effectuée",
                type : "alert-danger"
            }
        })
    }
    ...
    handleModificatonLivre = (id,titre,auteur,nbPages) => {
                                ...
                                if (livre.id !== this.state.idLivreAModifier){
                                    ...
                                    return (
                                        <tr key={livre.id}>
                                            ...
                                            auteur = {livre.auteur}
                                            nbPages = {livre.nbPages}
                                            validationModification={this.handleModificatonLivre}
                                            />
                                        </tr>
                                    );
                                }
